...
public class puzzle {
    ...
    public static void main(String[] args) {
        ...
        String jdbcURL = "jdbc:mysql://localhost:3306/SudokuDB";
        String dbUser = "Kavishnaa";
        String dbPassword = "Kavi@1234"; // Replace with your actual password
    ...
    private static void savePuzzleToDatabase(Connection connection, String puzzle, String solution) throws SQLException {
        String sql = "INSERT INTO SudokuPuzzles (puzzle, solution) VALUES (?, ?)";
